...
public class UsuarioController {
    ...
    private UsuarioDAO dao; //atualizado em 28/10
    ...
    public void salvarUsuario() {
       ...
       Usuario usuario = 
             new Usuario(view.getNome(), view.getLogin(), view.getSenha());
       dao.salvarUsuario(usuario); //atualizado em 28/10
       view.exibirMensagem("Usuário " + usuario.getNome() + " salvo com sucesso!");
    }
